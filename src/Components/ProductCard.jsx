...
const ProductCard = ({item}) => {
  ...
  return (
    <NavLink link to={`/details/${item.id}`}><div className='h-[400px] relative min-w-[240px] max-w-[240px] border-[1px] border-gray-400 rounded-[10px] overflow-hidden hover:cursor-pointer'>
        <img className='w-full' src={item.images[0]}/>

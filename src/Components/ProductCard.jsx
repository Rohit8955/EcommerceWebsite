...
const ProductCard = ({item}) => {
  ...
  return (
    <NavLink link to={`/details/${item.id}`}><div className='md:h-[400px] h-[307px] relative min-w-[200px] max-w-[200px] md:min-w-[240px] md:max-w-[240px] border-[1px] border-gray-400 rounded-[10px] overflow-hidden hover:cursor-pointer'>

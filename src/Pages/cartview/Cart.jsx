...
const Cart = () => {
  ...
  return ( 
    <div>
      <Header/>
      { cartitem>0?(<div className='mt-3 p-7 flex justify-center'>
        <div className='flex gap-9'>
          ...
          <div className='flex flex-col gap-7'>
            ...
            <div className='h-[200px] w-[450px] bg-white boxshadow p-3 flex flex-col gap-2'>
            ...
            <div className='h-[200px] w-[450px] boxshadow p-3'>
